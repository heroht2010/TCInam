...
<?php include("../GYMHTML/navbar_user.php") ?>
<div class="TC-bannercontent">
  <center><p style="font-family: Bangers;font-size: 60px;">HELLO, <?php echo $_SESSION['nam'] ?><br> WELCOME TO <b style="color: #FFF056">VN GYM</b></p>
    
  <button class="TC-btn-start"><span style="font-family:  Bangers;font-size: 27px"><b>MY PROFILE</b></span></button>   
  </center>
</div>
