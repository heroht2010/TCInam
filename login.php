...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../GYMCSS/login.css">
	<meta charset="utf-8">
...
<body>
  ...
  <div class="login">
    ...
    <div class="login-pass">
      ...
      <a href="../GYMHTML/logout.php" style="text-decoration: none;"><p style="font-family: Montserrat;font-size: 16px;color: white;text-align: right;margin-top: 2%;" class="wow fadeInUp">Chưa có tài khoản</p></a>
    </div>
    <div class="login-pass">
      <button class="btn-login" name="sub" onclick="valid()">Đăng nhập</button>
  ...
  <script type="text/javascript">
    function valid() {
      ...
      .always(function(response) {
        if (response!='') {
           document.getElementById("loi").innerHTML=response;
                  }
        else{
          $('body').load('GYM-trangchuuser.php');
        }
      });
     }
    }
