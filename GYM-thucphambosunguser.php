 ...
 <a href="../HTML/chuacokinhnghiem.html" style="font-size: 15px;font-family: Montserrat;text-decoration: none;outline: none;" class="hovertext">
  ...
  <div class="TPBS-title">
  	...
  	<div class="TPBS-title-cart">
  		<a href="../GYMHTML/GYM-giohang.php"><button><span class="glyphicon glyphicon-shopping-cart"></span><b style="font-family: Montserrat;margin-left: 3%">Giỏ hàng</b></button></a>
  	</div>
  </div>
  <div class="TPBS-list">
  ...
  <div class="TPBS-detail">
    ...
    <div class="TPBS-detail2">
    	<p style="text-align: center;display: block;border-bottom: 2px solid #FFF056;width: 100%;font-family: Montserrat;font-size: 25px" class="hovertext">WHEY PROTEIN</p>
    </div>
  ...
  <div class="TPBS-detail">
    ...
    <div class="TPBS-detail3"></div>
  	...
  	<?php 
     include("../GYMHTML/GYM-footeruser.php");
     ?>
</body>
</html>